...
def download(package_def, dir, overwrite)
...
if package.is_a? Hash
  package.each_pair do |k,v|
    download(v, dir, overwrite)
  end
else
  download(package, dir, overwrite)
end
